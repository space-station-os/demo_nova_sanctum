...
private:
    rclcpp::Subscription<demo_nova_sanctum::msg::WaterCrew>::SharedPtr tank_status_subscriber_;
    ...
    void tank_status_callback(const demo_nova_sanctum::msg::WaterCrew::SharedPtr msg);
